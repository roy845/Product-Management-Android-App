...
public class MainActivity extends AppCompatActivity implements OnClickProductInterface,NavigationView.OnNavigationItemSelectedListener {
...
//        observeAllProducts();
        ...
        deleteSelectedProductsImageButton.setOnClickListener(view->{
            ...
            dialog.setOnShowListener(dialogInterface -> {
                ...
                positiveButton.setOnClickListener(v -> {
                    ...
                    productViewModel.deleteSelectedProducts().observe(MainActivity.this, success -> {

                        if (Constants.SUCCESS.equals(success)) {
                            Toast.makeText(MainActivity.this,Constants.ALL_SELECTED_PRODUCTS_REMOVED_SUCCESSFULLY, Toast.LENGTH_SHORT).show();
                            deleteSelectedProductsImageButton.setVisibility(View.GONE);
                            dialog.dismiss();
                        }else {
                            Toast.makeText(MainActivity.this, Constants.FAILED_TO_REMOVE_SELECTED_PRODUCTS, Toast.LENGTH_SHORT).show();
                        }
                    });
                });
        ...
        deleteAllUsersImageButton.setOnClickListener(view->{
            ...
            dialog.setOnShowListener(dialogInterface -> {
                ...
                positiveButton.setOnClickListener(v -> {
                        ...
                        productViewModel.deleteAllProducts().observe(MainActivity.this, success -> {

                            if (Constants.SUCCESS.equals(success)) {
                                Toast.makeText(MainActivity.this,Constants.ALL_PRODUCTS_REMOVED_SUCCESSFULLY, Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }else {
                                Toast.makeText(MainActivity.this, Constants.FAILED_TO_REMOVE_PRODUCTS, Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    private void observeTotalProductCount(){
        productViewModel.getTotalProductCount().observe(this,totalProductCount -> {
    ...
    private void observeInitialLoadingLiveData(){
        productViewModel.getLoadingInitialProducts().observe(MainActivity.this,isLoadingProducts->{
    ...
    private void  navigateToErrorActivity(){
        startActivity(new Intent(MainActivity.this, ErrorLoadingProducts.class));
    }
    ...
    private void observeSortedProducts(String sortField, boolean ascending) {
        productViewModel.loadProductsSortedBy(sortField, ascending, (CURRENT_PAGE - 1) * Constants.ITEMS_PER_PAGE, Constants.ITEMS_PER_PAGE)
    ...
    private void observeAllProducts(){
        productViewModel.loadProductsByPage((CURRENT_PAGE-1)*Constants.ITEMS_PER_PAGE,Constants.ITEMS_PER_PAGE).observe(this,products -> {
            productAdapter.submitData(getLifecycle(), products);
             handleEmptyResults();
        });
    }
    ...
    private void searchUsers(String query) {
        ...
        productViewModel.searchProductsWithPagination(query,(CURRENT_PAGE-1)*Constants.ITEMS_PER_PAGE,Constants.ITEMS_PER_PAGE).observe(this, usersData -> {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if(direction == ItemTouchHelper.LEFT) {
                    ...
                    snackbar.setAction(Constants.UNDO, v -> {
                        ...
                        productViewModel.insertProduct(product).observe(MainActivity.this, success -> {
                            if (Constants.SUCCESS.equals(success)) {
                ...
                if(direction == ItemTouchHelper.RIGHT){
                    ...
                    Snackbar snackbar = Snackbar.make(viewHolder.itemView,"You archived "+product.getTitle(),Snackbar.LENGTH_LONG);
                    snackbar.setAction(Constants.UNDO, v -> {

                        productViewModel.updateProductArchivedState(product.getId(),false).observe(MainActivity.this, success -> {
                            if (Constants.SUCCESS.equals(success)) {
                                Toast.makeText(MainActivity.this, product.getTitle() + " restored successfully!", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(MainActivity.this)
                            .setMessage("Do you want to archive \"" + product.getTitle() + "\"?")
                            .setView(R.layout.custom_dialog_archive_buttons)
                            .setCancelable(false)
                            .create();
                    ...
                    dialog.setOnShowListener(dialogInterface -> {
                        ...
                        positiveButton.setOnClickListener(v -> {
                            if(itemPosition!=-1){
                                ...
                                productViewModel.updateProductArchivedState(product.getId(),true).observe(MainActivity.this, success -> {

                                    if (Constants.SUCCESS.equals(success)) {
                                        Toast.makeText(MainActivity.this, product.getTitle() + " archived successfully!", Toast.LENGTH_SHORT).show();
                                        snackbar.show();
                                        dialog.dismiss();
                                    }else {
                                        Toast.makeText(MainActivity.this, "Failed to archive " + product.getTitle() + ". Please try again.", Toast.LENGTH_SHORT).show();
                                        productAdapter.notifyItemChanged(itemPosition);
                                        dialog.dismiss();
                                    }
                                });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            startActivity(new Intent(MainActivity.this, ArchivedProductsActivity.class));
        }else {
            return false;
        }
